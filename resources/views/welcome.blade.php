            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                            ...
                            <form method="POST" action="{{ route('login') }}" action="#" class="needs-validation"
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Maaf nama pengguna / kata sandi yang anda masukkan salah</strong>
                                    </span>
                                    @enderror
                                </div>
                    ...
                    <div class="simple-footer">
                        Copyright &copy; {{ date('Y') }} <div class="bullet"></div> Lavinavera | Oleh <a
                            href="#">Akuntansi Universitas Diponegoro</a>
                    </div>
                </div>
            </div>
        </div>
